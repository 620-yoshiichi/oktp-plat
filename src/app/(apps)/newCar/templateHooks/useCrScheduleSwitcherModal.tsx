...
import { CrInspectionHistory, NewCar } from '@prisma/generated/prisma/client'

type crScheduleSwitcherModal = {
  theCar: NewCar
  lastHistory: CrInspectionHistory | null
}
export const useCrScheduleSwitcherModal = () => {
  return useGlobalModalForm<crScheduleSwitcherModal>(`crScheduleSwitcherModal`, null, {
    mainJsx: props => {
